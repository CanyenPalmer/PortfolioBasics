  ...
  experience: [
    {
      ...
      creations: [
        ...
        },
        {
          ...
          details: [
            "Python model that extracts specific information from Google Calendar entries throughout any set period, and exports all mined data to a new CSV for further testing.",
            "This practice saves 12+ hours a week from each sales rep.",
          ],
        },
      ],
      highlights: [
        "Oversee billing workflows, including deposit posting, payment reconciliation, balance transfers, and claim adjustment logic.",
        "Design and maintain billing SOPs that improve claim acceptance rates and reduce denials across major insurance groups.",
        "Build internal analytics tools using Python, Google Sheets, and ML models to support billing, rep performance, and operational forecasting.",
        "Develop and deploy Google Calendar–integrated machine learning systems to predict future revenue and schedule alignment.",
        "Create optimization models that support field representative efficiency, tying performance metrics directly to revenue outcomes.",
        "Act as the cross-functional analytics lead between billing, customer service, sales, and leadership, managing mission-critical projects across departments.",
        "Support time-sensitive DME billing processes including CGM product claims and intake logic.",
      ],
    ...
    },
    {
      ...
      highlights: [
        ...
        "Optimized Payor Level Dashboards, Billing Cycle Processes, Patient Information Checklist, HCPCS Code Validations, Cost/Reimbursement Data, and BrightTree Consignment to be interpreted throughout all departments of Iconic Care Inc.",
