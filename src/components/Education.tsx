...
type EduItem = {
  school: string;
  degree: string;         // e.g., "M.S. in Data Science"
  range?: string;         // e.g., "2024 — 2026"
  details?: string[];     // bullet points
  coursework?: Course[];  // highlighted courses
  badges?: string[];      // skills/tech badges
};
          ...
          {items.map((ed, i) => (
            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                ...
                {ed.range && (
                  <div className="text-white/60 text-sm md:text-base">{ed.range}</div>
                )}
              </div>
