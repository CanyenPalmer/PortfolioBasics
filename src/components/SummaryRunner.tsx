...
export default function SummaryRunner({
  ...
  return (
    ...
    >
      ...
      {/* Code card */}
      <div
        className={`absolute inset-0 rounded-xl overflow-hidden border border-white/10 bg-[#10151d]/70 shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_10px_40px_rgba(0,0,0,0.35)] transition-opacity duration-300 ${
        ...
        <div className="absolute inset-0 flex flex-col">
          <div className="flex items-center justify-between px-4 py-2 border border-b-0 border-white/10 rounded-t-xl bg-[#0f141b]/80 text-xs text-white/60">
            <div className="flex items-center gap-2">
              ...
              {/* Keep file name context while in terminal */}
          ...
          <div className="rounded-b-xl border border-t-0 border-white/10 bg-[#0f141b]/70 grow min-h-0">
            <TerminalBox
              ...
              lines={[
                ...
                { prompt: "$ ", text: "canyen_palmer_title" },
                {
                  prompt: "> ",
