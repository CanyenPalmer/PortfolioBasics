  ...
  return (
    <section id="contact" className="relative bg-[#0b1016] text-white pt-24 pb-0">
      ...
      <div className="mx-auto w-full max-w-7xl px-6 grid grid-cols-1 gap-16 lg:grid-cols-3 lg:gap-8">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-4">
            <li><Link href="#hero" className="block text-3xl font-semibold hover:text-cyan-400">Home</Link></li>
            <li><Link href="#about" className="block text-3xl font-semibold hover:text-cyan-400">About</Link></li>
            <li><Link href="#experience" className="block text-3xl font-semibold hover:text-cyan-400">Experience</Link></li>
            <li><Link href="#projects" className="block text-3xl font-semibold hover:text-cyan-400">Projects</Link></li>
            <li><Link href="#education" className="block text-3xl font-semibold hover:text-cyan-400">Education</Link></li>
            <li><Link href="#testimonials" className="block text-3xl font-semibold hover:text-cyan-400">Testimonials</Link></li>
          </ul>
        </div>
      ...
      <style jsx>{`
        ...
        .echo-bot { bottom: 0; }
        .echo-mid { bottom: 4em; }   /* raised higher */
        .echo-top { bottom: 7em; }   /* raised higher */
