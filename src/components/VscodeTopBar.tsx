    ...
    <header className="sticky top-0 z-50 bg-[#0b1016]/85 backdrop-blur supports-[backdrop-filter]:bg-[#0b1016]/60 border-b border-white/10">
      <nav className="mx-auto max-w-6xl px-4 py-3 flex items-center gap-4">
        ...
        <div className="flex items-center gap-4 text-sm">
          <Link href={resumeHref} className="rounded-lg px-3 py-1.5 ring-1 ring-white/15 hover:ring-white/30 hover:bg-white/[0.05] transition">Resume</Link>
          <a href={linkedinHref} target="_blank" rel="noreferrer" className="text-white/70 hover:text-white">LinkedIn</a>
          <a href={githubHref} target="_blank" rel="noreferrer" className="text-white/70 hover:text-white">GitHub</a>
